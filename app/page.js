...
export default function Home() {
  ...
  const addNumberOfQuestions = useQuize(state => state.addNumberOfQuestions)
    ...
    <section className="flex flex-col justify-center items-center my-10">
      ...
      <section className="my-10 rounded-lg p-10 shadow-xl lg:w-[75%] w-[80%]">
        <div>
          ...
          <input type="number" id="first_name" defaultValue={10} min={0} max={50}  onChange={(e) => addNumberOfQuestions(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0" required />
        </div>
